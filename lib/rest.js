...
// UPDATE
const getStatus = (req, res) => getData('http://localhost:3002/rest/status', res);
const sendUpdateRequest = (req, res) => getData('http://localhost:3002/rest/update', res);
...
router.get('/update', sendUpdateRequest)
